...
const cmsSections: CmsSection[] = [
  ...
  },
  {
    id: 'seo',
    title: 'SEO',
    description: 'Titulos, descripciones, keywords y Open Graph por cada pestaña publica.',
    sections: ['seo.pages'],
    collection: true,
    addSection: 'seo.pages',
    newContent: { path: '/', title: '', description: '', keywords: '', ogTitle: '', ogDescription: '', ogImage: '' },
    fields: [
      { key: 'path', label: 'Ruta' },
      ...
      { key: 'ogImage', label: 'Open Graph image', type: 'media' },
    ],
  },
  {
    id: 'footer',

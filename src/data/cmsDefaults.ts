...
export const cmsDefaults: CmsBlock[] = [
  {
    ...
    content: {
      path: '/',
      title: 'Group Emingser | Ingenieria que transforma industrias',
      description:
        'Soluciones integrales de ingenieria, mantenimiento industrial, generacion electrica, energia solar e infraestructura critica.',
      keywords: 'ingenieria industrial, mantenimiento industrial, energia solar, generacion electrica, Group Emingser',
      ogTitle: 'Group Emingser',
      ogDescription: 'Ingenieria, servicios industriales y proyectos de infraestructura critica.',
      ogImage: '',
    },
  },
  {
    ...
    content: {
      path: '/nosotros',
      title: 'Nosotros | Group Emingser',
      description: 'Conoce la historia, mision, vision y valores de Group Emingser.',
      keywords: 'Group Emingser, nosotros, ingenieria, servicios industriales',
      ogTitle: 'Sobre Group Emingser',
      ogDescription: 'Empresa de ingenieria y servicios industriales con presencia internacional.',
      ogImage: '',
    },
  },
  {
    ...
    content: {
      path: '/servicios',
      title: 'Servicios industriales y mantenimiento | Group Emingser',
      description: 'Servicios de mantenimiento, proyectos industriales, automatizacion, redes y soluciones tecnicas.',
      keywords: 'mantenimiento preventivo, mantenimiento correctivo, servicios industriales, proyectos industriales',
      ogTitle: 'Servicios Group Emingser',
      ogDescription: 'Soluciones tecnicas para infraestructura industrial y energetica.',
      ogImage: '',
    },
  },
  {
    ...
    content: {
      path: '/proyectos',
      title: 'Proyectos | Group Emingser',
      description: 'Portafolio de proyectos de ingenieria, energia e infraestructura industrial.',
      keywords: 'proyectos de ingenieria, infraestructura industrial, energia, subestaciones',
      ogTitle: 'Proyectos Group Emingser',
      ogDescription: 'Conoce nuestro portafolio de proyectos industriales.',
      ogImage: '',
    },
  },
  {
    section: 'seo.pages',
    item_key: 'branches',
    label: 'SEO Sucursales',
    sort_order: 4,
    is_hidden: false,
    content: {
      path: '/sucursales',
      title: 'Sucursales | Group Emingser',
      description: 'Presencia internacional de Group Emingser en America y el Caribe.',
      keywords: 'sucursales Group Emingser, contacto, Republica Dominicana, Panama, Ecuador, Nicaragua',
      ogTitle: 'Sucursales Group Emingser',
      ogDescription: 'Contacta nuestras oficinas y representantes internacionales.',
      ogImage: '',
    },
  },
  {
  ...
  },
  {
    ...
    content: {
      type: 'video',
      url: 'https://res.cloudinary.com/dah8wmc2g/video/upload/v1780592200/Video_solar_panels_functioning_202606041143_blwsmn.mp4',
    },
  },
  {

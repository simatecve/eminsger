...
import { ArrowLeft, MapPin, Calendar, Building2, Clock, CheckCircle2 } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <motion.div 
          ...
          className="rounded-3xl overflow-hidden aspect-[21/9] mb-16 relative"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {project.gallery.map((img, i) => (
            <motion.div 
              ...
              className="rounded-2xl overflow-hidden aspect-square border border-white/10"
            >
